...
import { Shield, Leaf, HardHat, Lock, Zap, Droplet, Car, Apple, Users } from "lucide-react"
...
export default function IsoCertificationCards() {
            ...
            >
              <Card className="h-full">
                <CardContent className="p-6">
                  <cert.icon className="w-12 h-12 mb-4" style={{ color: accentColor }} />
